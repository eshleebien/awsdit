...
from local_helpers import rds_helper
...
if __name__ == "__main__":
    ...
    if regions:
        ...
        output_bucket.append(rds_helper.sg_rule_sets_by_rds_header())
            ...
            if role:
                for region in regions.get('Regions'):
                    ...
                    thread_call = threading.Thread(
                         target=rds_helper.sg_rule_sets_by_rds, 
                         args=(rds, ec2, account, region, output_bucket))
