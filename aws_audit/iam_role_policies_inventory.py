...
if __name__ == "__main__":
    ...
    if regions:
       ...
       output_bucket.append(iam_helper.inventory_role_policies_header(encode))
       ...
       for account in accounts_db.accounts:
           ...
           if role:
               ...
               """
               call iam.list_role_policies() in multithreading mode 
               """
               thread_call = threading.Thread(
                    target=iam_helper.inventory_role_policies, 
